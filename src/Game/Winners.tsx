...
export default function Winners({ winners }) {
  ...
  return (
    <>
      <div className="player-stats-list column-shaped-container" style={{margin:'10% 0 0 0', maxHeight:'40%'}}>
      ...
      <button style={{marginTop:'10%'}} onClick={()=>{navigate('/')}}>Go back to menu</button>
